...
export class QualificationEngine {
    metrics = new QualificationMetricsCollector();
    audit = new QualificationAuditLogger();
    events = new QualificationEventEmitter();
    ...
    stressEngine = new StressEngine();
    chaosEngine = new ChaosEngine();
    scoreCalculator = new ProviderScoreCalculator();
    ranking = new ProviderRanking();
    async qualify(provider, requiredMethods) {
