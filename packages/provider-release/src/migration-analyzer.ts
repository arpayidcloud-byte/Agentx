...
export class MigrationAnalyzer {
  analyze(providerId: string, currentVersion: string, targetVersion: string, breaking: string[]): UpgradePlan {
    return {
      providerId,
      currentVersion,
      targetVersion,
      breakingChanges: breaking,
      migrationSteps: ['Update configuration format', 'Migrate existing data', 'Run new PSCK tests'],
