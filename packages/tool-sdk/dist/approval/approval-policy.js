 ...
 */
export function requiresAutoApproval(riskScore, policy) {
 ...
 */
export function requiresManualApproval(riskScore, policy) {
 ...
 */
export function requiresDoubleConfirmation(riskScore, policy) {
 ...
 */
export function isApprovalRequired(riskScore, policy) {
    return riskScore >= policy.manualApprovalThreshold;
}
