...
export type ApprovalEventType = 'approval.created' | 'approval.approved' | 'approval.rejected' | 'approval.cancelled' | 'approval.expired' | 'approval.executed' | 'approval.failed';
