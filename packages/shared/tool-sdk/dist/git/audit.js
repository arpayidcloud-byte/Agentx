 ...
 */
export function createGitInvokedEvent(operation, repository, branch, taskId, traceId, agentRole) {
    return {
 ...
 */
export function createGitFinishedEvent(operation, repository, branch, commitHash, exitCode, durationMs, taskId, traceId, agentRole) {
    return {
 ...
 */
export function createGitFailedEvent(operation, repository, taskId, traceId, agentRole) {
    return {
