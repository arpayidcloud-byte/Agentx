...
describe('Validator', () => {
  ...
  it('rejects empty nodes', () => {
    const wf = {
      id: 'wf-1', name: 'Test', version: 1, nodes: [], edges: [],
      variables: {}, metadata: { createdAt: new Date(), updatedAt: new Date(), createdBy: 'admin', traceId: 't1' },
    };
  ...
  it('rejects duplicate node IDs', () => {
    const wf = {
      ...
      edges: [], variables: {}, metadata: { createdAt: new Date(), updatedAt: new Date(), createdBy: 'admin', traceId: 't1' },
    };
    expect(() => validateWorkflow(wf)).toThrow(WorkflowValidationError);
  });
  ...
  it('validates node configs', () => {
    const validNode = createNode('n1', 'task', 'Task 1', { type: 'task', goal: 'test', priority: 1 });
...
describe('Checkpoint Manager', () => {
  ...
  it('creates and restores snapshots', () => {
    const nodeStates = new Map([['n1', 'COMPLETED'], ['n2', 'PENDING']]);
...
describe('WorkflowEngine', () => {
  ...
  it('compiles and executes a simple workflow', async () => {
    const wf = createWorkflow('wf-1', 'Simple Workflow', 'admin', [
  ...
  it('executes parallel nodes', async () => {
    const wf = createWorkflow('wf-parallel', 'Parallel Workflow', 'admin', [
  ...
  it('handles tool nodes', async () => {
    const wf = createWorkflow('wf-tool', 'Tool Workflow', 'admin', [
  ...
  it('handles agent nodes', async () => {
    const wf = createWorkflow('wf-agent', 'Agent Workflow', 'admin', [
      createNode('n1', 'agent', 'Code Review', { type: 'agent', role: 'reviewer', goal: 'review code' }),
    ], []);
  ...
  it('handles approval nodes', async () => {
    const wf = createWorkflow('wf-approval', 'Approval Workflow', 'admin', [
  ...
  it('supports pause and resume', async () => {
    const wf = createWorkflow('wf-pause', 'Pause Workflow', 'admin', [
  ...
  it('supports cancel', async () => {
    const wf = createWorkflow('wf-cancel', 'Cancel Workflow', 'admin', [
      createNode('n1', 'task', 'Step 1', { type: 'task', goal: 'test', priority: 1 }),
    ], []);
  ...
  it('builds metrics correctly', async () => {
    const wf = createWorkflow('wf-metrics', 'Metrics Workflow', 'admin', [
      createNode('n1', 'task', 'Step 1', { type: 'task', goal: 'test', priority: 1 }),
    ], []);
