...
export type ExecutionCoordinatorState = 'CREATED' | 'INITIALIZING' | 'READY' | 'SCHEDULING' | 'DISPATCHING' | 'EXECUTING' | 'WAITING_APPROVAL' | 'RECOVERING' | 'PAUSED' | 'COMPLETED' | 'FAILED' | 'CANCELLED';
